...
```{r}
null.inter_BC_mmglm=replicate(300, extr.null.int_mmglm(synchrony_spp_mmglm))

null.inter_BC_mmglm.df=data.frame(matrix(ncol=2, nrow = 300))
for(i in 1:300) null.inter_BC_mmglm.df[i,]=null.inter_BC_mmglm[,,i]
